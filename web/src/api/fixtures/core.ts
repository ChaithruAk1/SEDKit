  ...
  return {
    modules: [
      ...
      },
      {
        ...
        description: 'Delivery of new business applications: project register, plan milestones and slips, RAID log, Jira progress and forecast, requirements and ADR pages, delivery risks',
        version: '1',
        enabled: true,
